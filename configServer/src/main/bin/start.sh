...
nohup java $JAVA_OPTS $JAVA_MEM_OPTS $JAVA_DEBUG_OPTS $JAVA_JMX_OPTS -classpath $CONF_DIR:$LIB_JARS org.ligson.springclouddemo.main.ConfigServerMain > $STDOUT_FILE 2>&1 &
